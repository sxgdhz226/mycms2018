...
//	getTyphoonRoute:'data/typhoon.json',
	getTyphoonRoute:'/jeecms/web/tfljIntersk',
	/**得到台风预报信息**/
	getTyphoonForcast:'/jeecms/web/tfljInteryb',
	/**台风列表**/
	getTyphoonList:'/jeecms/web/tfljcallback',
//	getTyphoonList:'http://www.zhmb.gov.cn:8080/jeecms/web/tflj',
	/**获得首页的最新台风列表**/
	getNewTyphoonLiat:'/jeecms/web/typhoonindex',
	/**
	 * 实况中英文对应字典
	 */
	livedictionary: {
